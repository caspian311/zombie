...
(function() {
  ...
  Storages = (function() {
    ...
    Storages.prototype.local = function(host) {
      var area, _base;
      area = (_base = this._locals)[host] != null ? (_base = this._locals)[host] : _base[host] = new StorageArea();
      return new Storage(area);
    };

    Storages.prototype.session = function(host) {
      var area, _base;
      area = (_base = this._sessions)[host] != null ? (_base = this._sessions)[host] : _base[host] = new StorageArea();
      return new Storage(area);
    };
